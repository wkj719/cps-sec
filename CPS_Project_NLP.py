...
class KonlpySentences(object):  # 문장 분할 및 단어(명사) 추출
    ...
    def __init__(self):
        ...
        stopwords_path = r'C:\Users\pjw29\AppData\Local\Programs\Python\Python38\CPS\cps-sec\stopwords.txt' # 불용어 저장 텍스트 파일 경로
...
path = r"C:\Users\pjw29\AppData\Local\Programs\Python\Python38\CPS\cps-sec\headline.txt" # 크롬 헤드라인이 저장되는 텍스트 파일 경로
...
def chromeThread():
    ...
    while 1:
        ...
        if nowtime - lastTimeLong > 10800:  # 3시간 주기로 분석 수행
            h = TextHandling()
